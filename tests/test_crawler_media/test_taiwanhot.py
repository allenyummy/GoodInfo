...
from src.crawler.media import taiwanhot
...
TEST_DATA_1 = TEST_DATA(
    ...
    expected_output=NewsStruct(
        ...
        content="\n\n\n\n前總統馬英九。（圖／資料照片，圖源：馬英九Facebook）\n\n為振興國內經濟，行政院規劃推出振興五倍券，原先要民眾用「1000換5000」，但引發不少民進黨立委反彈。政院於昨(16)日與黨籍立委溝通後，拍板全民免付1千直接領券。對此，前總統馬英九今(17)日表示，五倍券與當年的消費券很近似，但他還是覺得為德不卒，並表示紓困一定要對症下藥，針對真正需要的民眾紓困才有意義，應該要發現金比較好。\n馬英九指出，現在最需要紓困的是基層服務業，因很多商家都已無法營業、沒有收入，但像工業與貿易情況還不錯，所以今年經濟成長還可以維持百分之5以上，所以一定要對症下藥，對真正需要的民眾紓困才有意義，他認為應該要發現金比較好。\n對於政院拍板全民免費領五倍券，遭外界質疑與當年馬政府時代的消費券有何不同？馬英九說，感謝大家說要還他公道，但還他公道不重要，要讓民眾有公道。 \n \n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
        keywords=None,
        category=None,
        media="台灣好新聞",
...
def newsCrawler():
    ...
    return taiwanhot.TaiwanHotNewsCrawler()
